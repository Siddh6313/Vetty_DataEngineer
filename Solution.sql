...
-- took refund_time as additional coulum as it was needed for some given querry--
CREATE TABLE transactions (
    buyer_id                 NUMBER,
    purchase_time            TIMESTAMP,
    refund_time              TIMESTAMP,
    refund_item              VARCHAR2(20),
    store_id                 VARCHAR2(20),
    item_id                  VARCHAR2(20),
...
1)
  --PURCHASE COUNT PER MONTH (EXCLUDING REFUNDED)
...
2)
  --COUNT STORES WITH >=5 ORDERS IN OCT 2020
...
3)
  --SHORTEST INTERVAL FROM PURCHASE TO REFUND
...
5)
  -- MOST POPULAR ITEM ON BUYER'S FIRST PURCHASE
...
SET refund_processable =
    ...
    END;
7)
--SECOND PURCHASE PER BUYER (IGNORING REFUNDS)
